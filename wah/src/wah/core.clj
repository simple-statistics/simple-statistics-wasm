...
(with-test
  ...
  (is (= 'f32 (:type (meta (assign-final-types {0 'f32} '(get_local 0))))))
  (is (= 'i32 (:type (meta (assign-final-types {} '(i32.const 0))))))
  (is (= 'f32 (:type (meta (assign-final-types {} '(f32.const 0))))))
  (is (= 'f64 (:type (meta (assign-final-types {} '(f64.const 0))))))
  (is (= 'i32 (:type (meta (assign-final-types {'$f 'i32} '(get_local $f)))))))
